...
alter table retention_campaign_types enable row level security;
...
alter table customer_retention_actions enable row level security;
...
alter table bundle_insert_sets enable row level security;
