...
const ADMIN_ONLY_CARDS: DashboardCard[] = [
  { href: "/admin/smaregi", title: "スマレジ連携", description: "スマレジAPI連携設定・同期状況" },
  { href: "/admin/users", title: "ユーザー権限", description: "管理画面ユーザーの招待・権限管理" },
];
...
export default async function AdminDashboardPage() {
  ...
  const sections = isAdmin
    ? [...SECTIONS, { title: "管理者用", cards: ADMIN_ONLY_CARDS }]
    : SECTIONS;
