    ...
    <div>
      ...
      <ProductForm
        ...
        initialValues={{
          ...
          customComparePrice: product.custom_compare_price ?? null,
          priceLabel: product.price_label ?? "",
          taxRate: product.tax_rate === 10 ? 10 : 8,
          shippingFee: product.shipping_fee,
          costAmount: product.cost_amount ?? 0,
          bundleInsertCost: product.bundle_insert_cost ?? 0,
          shippingCost: product.shipping_cost ?? 0,
          salesCommissionAmount: product.sales_commission_amount ?? 0,
